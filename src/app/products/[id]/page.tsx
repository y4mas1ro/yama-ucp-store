        ...
        <div className="min-h-screen bg-[#faf9f6] text-[#333] font-sans">
            <header className="py-6 px-8 border-b border-[#eee] bg-white">
                <div className="max-w-6xl mx-auto flex justify-between items-center">
                    <a href="/" className="text-xl font-serif tracking-widest uppercase">Yama Store</a>
                    <nav className="hidden md:flex gap-8 text-sm uppercase tracking-wider">
                        <a href="#" className="hover:text-pink-400 transition-colors">Spring Collection</a>
                        <a href="#" className="hover:text-pink-400 transition-colors">Best Sellers</a>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="flex flex-col gap-8 md:pt-4">
                        ...
                        <div className="flex flex-col gap-6 mt-4">
                            ...
                            <button className="w-full bg-[#333] text-white py-5 rounded-full text-lg font-medium hover:bg-black transition-all transform hover:scale-[1.01] active:scale-[0.98]">
                                カートに追加する
                            </button>
