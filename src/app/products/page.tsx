        ...
        <div className="min-h-screen bg-[#faf9f6] text-[#333] font-sans">
            <header className="py-6 px-8 border-b border-[#eee] bg-white sticky top-0 z-50">
                <div className="max-w-6xl mx-auto flex justify-between items-center">
                    <Link href="/" className="text-xl font-serif tracking-widest uppercase hover:text-pink-400 transition-colors">Yama Store</Link>
                    <nav className="hidden md:flex gap-8 text-sm uppercase tracking-wider">
                        <Link href="/products" className="text-pink-400 font-semibold">Shop All</Link>
                        <Link href="#" className="hover:text-pink-400 transition-colors">Spring Collection</Link>
